...
async function loadTimetable() {
    ...
    try {
        ...
        // ✅ تم تعديل الأوقات إلى فترات ساعة ونص (1.5 ساعة)
        const times = [
            '8:30-10:00', '10:00-11:30', '11:30-1:00', '1:00-2:30',
            '2:30-4:00', '4:00-5:30', '5:30-7:00', '7:00-8:30', '8:30-10:00'
        ];
...
function playNotificationSound() {
    try {
        ...
        // المستعرض لا يدعم AudioContext
    }
}

// ✅ تعديل showNotification لتشغيل الصوت مع كل إشعار
...
async function updateRealStats() {
    ...
    try {
        ...
        const studyHours = subjectsSnapshot.size * 2;
